  ...
  return (
    <>
      <div className="page-header">
        <div>
          <h1 className="page-title">Sales by Business</h1>
          <p className="page-subtitle">Completed mobile money and voucher sales, grouped by business.</p>
        </div>
      </div>

      <div className="stats-grid" style={{ marginBottom: 20 }}>
        {[
          { label: 'Businesses with Sales', value: `${data?.summary.tenantCount ?? 0}`, color: 'blue' },
      ...
      {!data && (
        <div className="card">
          <div className="empty-state">
            <p>Sales data is not reachable yet. Once the billing API responds, this page will show live revenue by business.</p>
          </div>
        </div>
      )}
      ...
      <div className="card">
        <div className="card-header">
          <span className="card-title">Business Sales Breakdown</span>
        </div>
