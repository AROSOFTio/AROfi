...
async function main() {
  ...
  const mobileMoneyPayment = await prisma.payment.create({
    data: {
      ...
      customerReference: '+256700111222',
      externalReference: 'MTN-APR-2026-0001',
      providerReference: 'MTN-TXN-APR-0001',
      ...
      messages: {
        create: [
          ...
          },
          {
            ...
            authorRole: 'Support',
            body: 'Activation was replayed after mobile money status confirmation. Service is now active.',
          },
        ],
      },
    },
