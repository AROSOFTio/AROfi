...
# deliberately long idle timeout and no keepalive timeout. A previous guard still
...
for marker in (
    ...
    require(
        MIKROTIK,
        marker,
        "MikroTik 31-day idle session protection is missing; router session policy is inconsistent.",
    )
require(
    RADIUS_CREDENTIAL,
