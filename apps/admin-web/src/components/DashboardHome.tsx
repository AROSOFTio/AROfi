  ...
  const stats = [
    {
      ...
      color: 'vibrant',
      change: 'Completed platform sales',
    },
    {
      label: 'Total Tenants',
      value: `${tenants?.summary.totalTenants ?? 0}`,
      color: 'green',
      change: 'Vendors on platform',
    },
    {
      label: 'Active Hotspots',
      value: `${tenants?.summary.totalHotspots ?? 0}`,
      color: 'amber',
      change: 'Configured hotspot sites',
    },
    {
    ...
    <>
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Live platform overview sourced from billing, router, voucher, and tenant records.</p>
        </div>
        <div style={{ display: 'flex', gap: 10 }}>
          <a href="/transactions" className="btn btn-ghost">View Transactions</a>
          <a href="/tenants" className="btn btn-primary">+ Add Tenant</a>
        </div>
      </div>
