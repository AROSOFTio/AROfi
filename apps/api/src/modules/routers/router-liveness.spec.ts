...
function buildService() {
  return new RoutersService({} as never, {} as never, {} as never, {} as never, { publish: jest.fn() } as never)
}
...
describe('RoutersService heartbeat publishes realtime events', () => {
  it('publishes router.heartbeat on every beat and router.online after a gap', async () => {
    ...
    const service = new RoutersService(prisma as never, {} as never, {} as never, {} as never, realtimeEvents as never)
