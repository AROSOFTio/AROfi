...
gateway patches, validates the final ioTec OAuth/diagnostics output, installs
the active-bundle disconnect guard, then verifies the MikroTik captive/session
policy.
...
def main() -> None:
    ...
    print(
        "Final payment gateway, ioTec diagnostics, active-bundle disconnect guard, "
